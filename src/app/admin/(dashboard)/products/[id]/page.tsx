...
export default function EditProduct() {
  ...
  return (
    <>
      {showToast && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center bg-[#FFC93C] text-[#1a1c1b] border-2 border-[#1a1c1b] px-4 py-3 shadow-[4px_4px_0px_0px_rgba(26,28,27,1)] max-w-[440px] w-full mx-auto">
          <Save className="size-6 mr-3 font-bold" />
        ...
        <div className="p-8 pb-12">
          ...
          <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); handleSave() }}>
            <div>
              ...
              <p className="font-mono text-[16px] leading-[24px] font-bold">#PRD-90210-XYZ</p>
            </div>
            ...
            <div>
              ...
              <input id="productName" type="text" defaultValue="Ergonomic Desk Chair V2"
            ...
            <div>
              ...
              <div className="relative">
                <select id="category" defaultValue="furniture"
                ...
                <ArrowDown className="size-5 absolute right-0 top-1/2 -translate-y-1/2 pointer-events-none text-[#1a1c1b]" />
              </div>
            </div>
            ...
            <div>
              ...
              <input id="affiliateLink" type="url" defaultValue="https://shopby.com/ref/8923a"
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input id="price" type="text" defaultValue="1.250.000"
            ...
            <div className="flex items-center justify-between py-4 border-y border-dashed border-[#e5e1d8] my-8">
              <span className="font-mono text-[12px] leading-[16px] font-medium text-[#76737b] uppercase">Status</span>
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                <span className="ml-3 font-mono text-[13px] leading-[16px] tracking-[0.05em] uppercase text-[#1a1c1b]">{status ? "Active" : "Inactive"}</span>
              </label>
            </div>

            <div className="pt-6 space-y-4">
              <button type="submit"
                className="w-full bg-[#FF4D2D] text-[#1a1c1b] font-sans text-[20px] leading-[28px] font-bold py-4 px-6 rounded-full border border-[#1a1c1b] transition-all active:translate-y-0.5 active:translate-x-0.5 flex items-center justify-center">
                <Save className="size-5 mr-2" />
                Save Changes
              </button>
              <button type="button" onClick={() => router.back()}
                className="w-full bg-transparent text-[#5d5b62] font-mono text-[13px] leading-[16px] tracking-[0.05em] uppercase py-3 hover:text-[#1a1c1b] transition-colors underline decoration-dashed underline-offset-4">
                Discard Edits
              </button>
            </div>
          </form>
